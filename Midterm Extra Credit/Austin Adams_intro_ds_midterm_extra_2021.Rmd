...
(c) (2 points) Create side-by-side boxplots that show the distribution of the numerical variable you chose in part (a) for the 3 different types of `Species`. _Make sure to comment on your results_.
